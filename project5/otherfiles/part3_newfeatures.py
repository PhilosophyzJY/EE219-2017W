...
# Linear Regression using more features #
...
for line in open('tweets_#gopatriots.txt', 'r'):
...
for n in range(1,max(byHour)):
  ...
  temp = []
  count = 0
#construct new features by hour
  h_fav=0
  h_rank=0
  h_acc=0
  h_imp=0
...
# Calculate statistics #
  for x in range(0,length):
    if byHour[x] == n:
       ...
       h_mom = h_mom + momentums[x]
       hourtime.append(houroftheday[x])
