...
def main():
	...
	AverageTweetsPerHour('tweets_#superbowl.txt','For #superbowl, the stats are:')


def AverageTweetsPerHour(filename,title):
...
#   	
# 	# Change this line for the hashtag #
# 	workbook = xlsxwriter.Workbook('Superbowl Histogram.xlsx')
#   	
